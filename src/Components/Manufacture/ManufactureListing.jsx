         ...
         {/* Delete Dialog Box */}
            ...
            >
                <Box p={3}>
                    ...
                    <Box align='right'>
                        <Button className='cancel_btn me-3'>Cancel</Button>
                    ...
                    <Box p={3}>
                        ...
                        <div className="container-fluid p-0 m-0">
                               <div className="row">
                                ...
                                <input type='text'
                                //  onChange={(e) => brandData.current.brand_name = e.target.value}
                        ...
                        <Box align='right' className='mt-3'>
                            ...
                            <Button variant="contained" sx={{background:'#534ba8'}}>Add</Button>
                        </Box>
                    </Box>
                ...
                >
                    <Box p={3}>
                        ...
                        <div className="container-fluid p-0 m-0">
                                ...
                                <input type='text'
                                //  onChange={(e) => brandData.current.brand_name = e.target.value}
                                //   defaultValue={brandData.current.brand_name} 
                                  placeholder="Enter Brand Name" className="form-control w-100 mb-2" />
                            </div>
                        ...
                        <Box align='right' className='mt-3'>
                            ...
                            <Button variant="contained" sx={{background:'#534ba8'}}>Update</Button>
                        </Box>
                    </Box>
                        ...
                        {allCompanies.map((res, index) => {
                            return (
                                <TableRow key={index}>
                                    ...
                                    <TableCell>{res.manufacture_name}</TableCell>
                                    <TableCell>
                                        <Delete />
                                        <Edit  onClick={()=>setOpen1(true)}/>
