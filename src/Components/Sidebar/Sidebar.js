        ...
        <>
                ...
                <div className="d-flex" style={{ height: '100%', width: '100%' }}>
                    <div className="sidebar_main_con" style={{ width: matches? toggleSidebar ? '270px' : '0px' : !toggleSidebar ? '270px' : '0px'}}>
                        ...
                        <Box onClick={() => setContainerToggel(!containerToggel)} className="fs-5" sx={{cursor:"pointer"}}><span className="d-flex justify-content-between align-items-center"><span>Contain</span> <KeyboardArrowDownIcon sx={{transition:'0.3s',transform:containerToggel?'rotate(180deg)':'rotate(360deg)'}}/></span><hr className="mb-3 mt-1"/></Box>
